...
export function getClient() {
  ...
  console.log("Contentful preview mode:", preview);
  console.log("Contentful host:", preview ? "preview.contentful.com" : "cdn.contentful.com");
  console.log("Contentful env:", ENV_ID);
  console.log("Has preview token:", !!CPA_TOKEN);
